...
namespace cryptonote
{
  ...
  {
    if (BLOCK_MAJOR_VERSION_2 != bl.major_version && BLOCK_MAJOR_VERSION_3 != bl.major_version && BLOCK_MAJOR_VERSION_4 != bl.major_version && BLOCK_MAJOR_VERSION_5 != bl.major_version && BLOCK_MAJOR_VERSION_6 != bl.major_version && BLOCK_MAJOR_VERSION_7 != bl.major_version && BLOCK_MAJOR_VERSION_8 != bl.major_version)
      return false;
  ...
  bool check_proof_of_work(const block& bl, difficulty_type current_diffic, crypto::hash& proof_of_work)
  {
    ...
    case BLOCK_MAJOR_VERSION_6: return check_proof_of_work_v1(bl, current_diffic, proof_of_work);
    case BLOCK_MAJOR_VERSION_7: return check_proof_of_work_v1(bl, current_diffic, proof_of_work);
    case BLOCK_MAJOR_VERSION_8: return check_proof_of_work_v1(bl, current_diffic, proof_of_work);
    }
